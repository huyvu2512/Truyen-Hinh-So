    ...
    <div className="flex-1 max-w-[1400px] w-full mx-auto px-6 py-8 flex flex-col lg:flex-row gap-8">
      ...
      <aside className="w-full lg:w-80 bg-[#121216] border border-[#22222b] rounded-2xl flex flex-col h-[600px] overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-2 flex flex-col gap-1">
          {isUnlocked ? (
            ...
            /* Skeleton Loading Channels */
            Array.from({ length: 8 }).map((_, index) => (
              <div
                key={index}
                className="flex items-center gap-3 p-3 rounded-xl border border-transparent"
              >
                <div className="h-10 w-16 flex-shrink-0 bg-[#16161c] rounded-md border border-[#22222b] relative overflow-hidden">
                ...
                <div className="flex-1 flex flex-col gap-2">
                  <div className="h-4 bg-[#16161c] rounded w-2/3 animate-pulse border border-[#22222b]/30" />
                  <div className="h-3 bg-[#16161c] rounded w-1/3 animate-pulse border border-[#22222b]/20" />
                </div>
              </div>
            ))
          )}
      ...
      <main className="flex-1 bg-[#121216] border border-[#22222b] rounded-2xl p-6 flex flex-col h-[600px] overflow-hidden">
        {isUnlocked ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-6 select-none relative">
            {/* Background Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] bg-[#00d4ff] opacity-[0.02] blur-[60px] rounded-full pointer-events-none" />
            
            <div className="max-w-sm z-10 flex flex-col items-center">
              <div className="w-14 h-14 rounded-full bg-[#16161f] border border-[#22222b] flex items-center justify-center mb-5 shadow-[0_0_20px_rgba(0,212,255,0.05)]">
                <svg className="w-6 h-6 text-[#00d4ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <p className="text-gray-400 text-xs mb-6 leading-relaxed">
                Vui lòng kích hoạt dịch vụ để sử dụng lịch phát sóng.
              </p>

              <Link
                href="/truyenhinh"
                className="px-8 py-3 bg-[#00d4ff] hover:brightness-110 text-black font-extrabold text-xs rounded-xl transition-all active:scale-[0.98] shadow-[0_4px_15px_rgba(0,212,255,0.2)]"
              >
                Kích hoạt
              </Link>
            </div>
